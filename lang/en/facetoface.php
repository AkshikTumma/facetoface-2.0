...
$string['facetoface:addinstance'] = 'Add capability to face-to-face session';
...
$string['eventcancelbookingsuccess'] = 'Cancel booking';
$string['eventcancelbookingfailed'] = 'Could not cancel booking';
...
$string['eventsignupsuccess'] = 'Signup for a session';
$string['eventsignupfailed'] = 'Signup for a session failed';
$string['eventupdatemanageremailfailed'] = 'Manager\'s email update failed';
